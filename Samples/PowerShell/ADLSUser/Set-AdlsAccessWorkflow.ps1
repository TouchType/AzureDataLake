workflow adlsAccessSet {
       ...
       foreach -parallel ($path in $adlspaths){
        ...
        {
            "$path"
            C:\Users\skadmin\agent\_work\1\s\Set-AdlsAccess.ps1 -Account analyticstelemetry -Path /app-telemetry/parquet_flat/SwiftKey_Android_prod/ -EntityId 609efa91-4471-4a8f-b421-fce5286fba17 -EntityType Group -SetAclEntry -Permissions ReadExecute
